...
public class Undergraduate {
	...
	public static void main(String[] args) {
		try {
			...
			initExcelWriter();
			initMajorList("https://le.ac.uk/courses?q=&level=Undergraduate+Course&Page=");
	...
	public static void getDetails(int row,MajorForCollection major) throws Exception {
		...
		major.setScholarship("Alumni Music Scholarship$500;"+
							"Philharmonia Scholarship$500;"+
							"University of Leicester Scholarship$1000;"+
							"Chancellor's Scholarship$1000;"+
							"Golf Bursary$985;"+
							"Our Platinum Scholarship$5000");
	}
